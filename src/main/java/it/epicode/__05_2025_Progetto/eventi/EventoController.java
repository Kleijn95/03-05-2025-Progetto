...
import it.epicode.__05_2025_Progetto.auth.AppUser;  // Importa la classe AppUser
import it.epicode.__05_2025_Progetto.auth.AppUserService;  // Servizio per gestire AppUser
